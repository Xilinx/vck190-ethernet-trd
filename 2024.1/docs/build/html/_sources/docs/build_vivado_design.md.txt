...
1. Download the 2024.1 Source Files from <a href="https://github.com/Xilinx/vck190-ethernet-trd">TRD Home Page </a> .

2. Unzip the TRD package.

3. Navigate to the `../vck190-ethernet-trd-2024.1` which is the working directory.
...
Running the `../vck190-ethernet-trd-2024.1/Makefile` will generate the hardware platform XSA and subsequently the petalinux images.

1. Go to the working directory

   ```
   cd vck190-ethernet-trd-2024.1
   ```
...
* Generate XSA using `../vck190-ethernet-trd-2024.1/vivado/Makefile`


1. Go to the platform directory specific to the application

   ```
   cd vck190-ethernet-trd-2024.1/vivado/
   ```
...
3.	The generated XSA will be located at:
   ...
   ```
* Generate XSA from top make file `../vck190-ethernet-trd-2024.1/Makefile`:
...
4. In the Flow Navigator pane on the left-hand side under Program and Debug, click on Generate Device Image. The device image (pdi) for the design will be generated and available at `$working_dir/vivado/<platform_name>/project/impl_1/mrmac_subsys_wrapper.pdi`.
