...
* Run-time switchability between 10G and 25G
* 1-step and 2-step Precision Time Protocol (PTP)
* PL based PTP Packet processors for 1-step and 2-Step PTP operation
