...
* For more details on the checksum and correction factor port description and operation, please refer to PG314- Versal Devices Integrated 100G Multirate Ethernet MAC Subsystem v1.3 <hyperlink>
...
The PTP detect logic checks the Type field of the received packet whenever a new Ethernet packet is received

 and also checks for the Multicast IP Destination Address for UDP IPV4 Packets, to carry out the PTP detection.
