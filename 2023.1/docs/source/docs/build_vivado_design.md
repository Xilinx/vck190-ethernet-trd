...
1. Download the 2023.1 Source Files from <a href="https://github.com/Xilinx/vck190-ethernet-trd">TRD Home Page </a> .

2. Unzip the TRD package.

3. Navigate to the `../vck190-ethernet-trd-2023.1` which is the working directory.
...
Running the `../vck190-ethernet-trd-2023.1/Makefile` will generate the hardware platform XSA and subsequently the petalinux images.

1. Go to the working directory

   ```
   cd vck190-ethernet-trd-2023.1
   ```
...
* Generate XSA using `../vck190-ethernet-trd-2023.1/vivado/Makefile`


1. Go to the platform directory specific to the application

   ```
   cd vck190-ethernet-trd-2023.1/vivado/
   ```
...
3.	The generated XSA will be located at:
   ...
   ```
* Generate XSA from top make file `../vck190-ethernet-trd-2023.1/Makefile`:
...
Follow the steps below to build petalinux images using the Makefile in `../vck190-ethernet-trd-2023.1/petalinux/xilinx-vck190-trd path`

1. Go to the petalinux BSP folder.

   ```
   cd ../vck190-ethernet-trd-2023.1/petalinux/xilinx-vck190-trd
...
3. The generated images will be located at:
   ...
   ```
   ../vck190-ethernet-trd-2023.1/petalinux/xilinx-vck190-trd/images/linux
