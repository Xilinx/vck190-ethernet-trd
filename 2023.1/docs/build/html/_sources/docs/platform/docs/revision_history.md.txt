...
* Individual prebuilt petalinux images are shared in place of *.wic image.
...
* IDT drivers for GT Refclk

## 2021.2 Release

* Support for 25G.
* Dynamic switching between 10G and 25G.
* Added the 25G 1-step PTP feature.
